...
// Maps backend strategy key → pill colour class (reuses existing severity-tag palette)
const STRATEGY_SEVERITY = {
  flash_sale:        'critical',   // urgent — red
  discount_campaign: 'high',       // warning — amber
  buy2get1:          'medium',     // teal
  bundle:            'medium',
  cross_sell:        'low',        // neutral
}
...
export default function InventoryPage({
  ...
  return (
    <div className="inventory-page">
      ...
      {/* ── AI Purchase Planner section — UNTOUCHED ── */}
      ...
      {/* ── NEW: Smart Dead Inventory Recovery section ── */}
            ...
            <div className="dead-inv-list">
              {deadItems.map((item) => (
                <div key={item.product} className="dead-inv-item">
                  ...
                  {/* Header: product + staleness badge + strategy badge */}
                  ...
                  {/* Key metrics — reuses .metric-item/.metric-label/.metric-value */}
